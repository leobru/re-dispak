...
***
диасм7	пам	0
	сч	рсвсм1         если <>0 - тестовый режим
	по	нстдкс         стандартный режим
	нед	П77777
	уи	М16
	и	П77777
	сда	64-24
...
вы9  	нтж     Е48 !ПРОЦЕДУРА МОДИФИЦИРОВАНА
        ...
        зп      ШРНОМБ
        пб      СТАТ1
ВЫХНБ СЧ Е26 !ШТАТН. Маличев. Штатно Е36
 ПБ ОТКАЗН
****** БЛОК ДЛЯ РАБ. К-71 ***********
...
взв1	сч	E48(М4)
	...
	мода	взвра
	пино	(М13)
	уиа	взв2-Н(М17)     "ВЗВ2-Н" НЕ ХВАТ. СТР.
	сч	КВТ
	или	е30п28
	и	(М2)
	зп	ТЗНМЛ(М12)
...
н2	мода	н1
	пв	(М17)
вызсм3	мода	заказы-У3(М7)
	уиа	0(М16)
	уиа	КУСНЕР-Н(М5)
	пб	ВЫЗАСЧ в СМЕНА3
рабди	сч	НЗ ИЗ СМЕНЫ3
	или	НЗ+1
	по	НВМЛ4
	сч	кробш
	и	Е48П42
