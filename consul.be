...
* ПВ ПРЛТВ(М14)    ЗАХВАТ Е17,ПРИП.ЛТВЫД К ЛИСТ.М.
      сч   Е17
      пв   захзан(М15)	ЗАХВАТ БУФЕРОВ ВЫВОДА НА ТЕРМИНАЛЫ
      сч   в6050
      пв   тбуф(М15)	ЗАПРОС 1-ГО ЛИСТА
      уиа  3
      сда  64-8
      уи   М14		АДРЕС 1-ГО ЛИСТА
      уии М15(М14)
      мода екл		ПРОВЕРКА НА КЛЮЧ
      пв   (М16)
      уиа  0(М12)	ПРИЗНАК 1-ГО ЛИСТА
      уиа  0(М11)
      уиа -68(М17)
      уии М15(М14)
ПОИСК НОП ,
...
взят ноп 
      сч в6050
      слц е1
      пв тбуф(м15)	ВЗЯТИЕ ВТОРОГО ЛИСТА
      уиа 3
      сда 64-8
      уи м12		АДРЕС ВТОРОГО ЛИСТА
      мода сс		ЛИСТ ДЛЯ ЗАНЕСЕНИЯ ССЫЛКИ
      пино (м11)
      уии м15(м12)
      мода екл		ПРОВЕРКА НА КЛЮЧ
      пв (м16)
...
НАШЛИ НОП
 СЧИ М15
      и п1777
      уиа -11(м17)
      мода зп1		ЗАПИСЬ В ПЕРВЫЙ ЛИСТ
      пио (м12)
      или е47
зп1 зп ря2		ССЫЛКА НА ПОСЛ. ЗАКАЗ
      сч (м2)
ЗПНОЛЬ НОП
      или E48п41
      нтж E48п41
      или е44п41	ПРОБЕЛ ВМЕСТО НОМЕРА УСТРОЙСТВА
 ЗП (М15)
ПЕРЛТВ НОП
      сч 1(м2)
      зп 1(м15)
 ...
 ИЛИ ЕВЫД
 ЗП ШКОРАБ
 мода ТС(м14) уточнить !КОНСУЛ-100 "МОДА ТС(М14)"
 сч (м3)
 по первая	ПЕРВЫЙ ЗАКАЗ
 уи м4		АДРЕС ЗАКАЗА В ЛИСТЕ
 и е47
ОТКАЗ1  пе      вых1	ССЫЛКА НА ВТОРОЙ ЛИСТ
        уии     М15(М14)
сс1  ноп        
        сч      ря2        
        или     Е31
...
зп2  и       св
        ...
        или     ря2        
        мода    ТС(М14)  
        зп      (М3)	ССЫЛКА НА НОВЫЙ ПОСЛ. ЗАКАЗ
        счи     М12
НЕТМЕС НОП
        по      взв	ВОЗВРАТ 1 ЛИСТА
        сда     64-2
        или     лтвыд1
        пв      ТБУФ(М15)	ОТДАН 2-Й ЛИСТ
взв  счи     М14
        сда     64-2
        или     лтвыд1
        пв      ТБУФ(М15)	ОТДАН 1-Й ЛИСТ
        сч      Е17
        мода    отказ
        уиа     (м15)
        пб      гашзан
вых1    ноп
        мода сс2лт	ВЗЯТЬ ВТОРОЙ ЛИСТ
        пио (м12)
сс уии м15(м12)
       пб сс1
сс2лт ноп
...
екл  сч      КЛЮКОН(М15)
        нтж     ключтм
        по      (М16)	КАТАЛОГ ЕСТЬ, КЛЮЧ СОВПАЛ
        уиа     -47(М17)        
        уиа     -68(М1)
        сч      ключтм        
        зп      КЛЮКОН(М15)    
