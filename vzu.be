...
кик7а	уи	М17 !ИЗ ДИСП70.КИК
	...
	и	E48-1(М17)
	по	вз71б
	сч	рабдкс+21(М17) !ИСП. В РАБ. С Э50133(ЭК7)
	сд	масас7(М16) !МАСКА?
	и	П7
	кк	26,'70000' !132,0 !ПРИ СОЕДИНЕНИИ С ДКС
* ПРИ РАБ. С Э50 '133'
вз71б	сч	И17
	уи	М17
	пб	КИК1 ПРОДОЛЖ. В ДИСП70.КИК1
швзк7а	пам	1
швзк7б	пам	1
масас7	конд	в'4400000000000000'
...
*
шкаэко	пам	1
выдас7	сч	шкут  !ИЗ ВЗУ.нтт4
	и	E48(М2)
	по	боэте4 !ДЛЯ ТЕРМ ЧЕРЕЗ КВУ?
	мод	базсв7
	пб	св7ас1-СВЯЗЬ7 !В СВЯЗЬ7.св7ас1
*!РАБОТА ПО ВЫДАЧЕ ЧЕРЕЗ ДКС
*НАМ НУЖНО СЮДА
кмас7	уиа	E45(М10) !ИЗ ВЗУ.КМ
	сч	шкут
	и	E48(М2)
	мод	базсв7
	пе	св7ас2-СВЯЗЬ7 !В СВЯЗь?
	пб	км1a  !В ВЗУ ЕСЛИ НЕ ЧЕРЕЗ ДКС
*
Э1	сч	ГУС
	и	E48
	по	э1б
	...
	мод	НЗАД
	и	E48-1
	по	э1а !ВЕРОЯТНО ЗДЕСЬ ДОЛЖЕН БЫТЬ
* ПЕРЕХОД НА ДИСП70.э52к71
э1б	слиа	'77645'(М16) !ОТРИЦ. ЧИСЛО
	мод	базэко
	пио	э1в-ЭКО(М16) !ЗДЕСЬ ДОЛЖЕН БЫТЬ
*ПЕРЕХОД В ЭКО. КАКОЙ АДРЕС?
	слиа	E24(М16)
	пб	э1а
	пам	5
***** КОНРАБ К-71 *****
...
КОНФУС внеш базсв7,базэко,рабдкс
СВЯЗЬ7 ВНЕШ СВЯЗЬ7,св7ас1,св7ас2
МОТТ ВНЕШ ЗАН,эспец
ЭКО  ВНЕШ ЭКО,э1в
 ВХОД загл7б,шкаэко,швзк7а,швзк7б,шкут,кик7а,загл7а
