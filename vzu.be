...
андив	сч	РАЗМГ+1
	...
	уиа	(М16)
	сч	E48-1(М16)
	зп	шдисп5  ЗАКРЫТЬ ЗАДАЧУ РАЗМ. ДО ОПРЕД. ЗАДАНИЯ
	пб	АНВО9Б
НЕЛЬ	мод	НЗАД
	уиа	(М16)
АНВО9Б	счи	М15
...
ПОДВ82	сч	СОЛ-3(М16)
	...
	уиа	(М1)       М1 = 0: ОБХОД СН. ЗАЩ. И ВОССТ. ПРИП.
	пб	ВЫХ1 
ПОДВЕД	сч	ЗОНАТР
	нтж	ЗОНАМЛ
	пе	зпмг  МЛ НЕ ПОДВЕДЕНА
	сч	СОЛ-3(М16)
	и	E48(М15)
...
ДИСКИ ВНЕШ РАБМД,СЧЗАКД,дг5,ВХОДМД,ф37г,физомд
...
ХЛАМ ВНЕШ НАЧАЧУ,ПРУ12,ПЕРЕ,н587,зпмг,несчет,ПОДВ80
ДМЛМБ ВНЕШ фи56,фи5,ЗКМЛ,ДИСПМБ,КСМ,ГАШСОЛ,ЗОНТАБ
ДМЛМБ ВНЕШ ВЫХ1,ДИСО1А,ДИСМБ2,ДИСПО,ВЫХОД1
зон676 внеш базадр,к71ш15
...
ДИСП70 ВНЕШ АСБОЙБ,Е37Е36,шдисп4,БЯК,Е42П1,ТЗОНМЛ,РСЧРАЗ,П13
ДИСП70 ВНЕШ П27,шдисп1,тв210,НМБТР,шдисп2,МИН17
...
*
 ...
 ВХОД Э1,ЗОВЫ,УИИ,СММ16,ЗАПЭКС,ЭКЛИСТ,ЭКВЫХ1,АНВО6А,фзокм1,ПР
 ВХОД взук71,ВЫЗКЧ,ST7007,ЗАПРОС,сис1,СБОЙБ,ЭККВМ,ПОК,ФЗО3В
 ВХОД ЭКС75,ЭКП,ЗОВИ,ПРХЭ67,ГОША,АЦПУ,ТУМБР,ФЗО5,АНВО1Е,ВОЗЬМИ
 ВХОД U7045,U7050,ВХЛ,ВХМД,шквзу1,шквзу2,ппп3,ФИЗУР,БИБ,ФИЗО
 ВХОД u5350,u5443,u5542,АНВО9,ФТН,ФЗОН,U5222,шфзобм,ПРИП1С,Э72
 ВХОД ФИЗЗП,П,ВЫ,ПРКА,РАЗРЕ,АДЭК,КРАХМЛ,УЗЩ8,ФИЗИЧ,швзк7б,УЗЩ8В
 ВХОД АНВО9Б,ВТРУБУ,АНВО1,шквзу3,швзк7а,узщ8г,ДСЛ,ПОДОШ,АНВО8А
 ФИНИШ
