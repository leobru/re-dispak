...
андив	сч	РАЗМГ+1
	...
	уиа	(М16)
	сч	E48-1(М16)
	зп	ШЗРАЗМ+1  ЗАКРЫТЬ ЗАДАЧУ РАЗМ. ДО ОПРЕД. ЗАДАНИЯ
	пб	АНВО9Б
НЕЛЬ	мод	НЗАД
	уиа	(М16)
АНВО9Б	счи	М15
...
кик7а	уи	М17  <-- ИЗ ДИСП70.КИК
	...
	и	E48-1(М17)
	по	кик7б
	сч	туsаб(М17) !ИСП. В РАБ. С Э50133(ЭК7)
	сд	масас7(М16) !МАСКА?
	и	П7
...
кик7б	сч	И17
	уи	М17
	пб	КИК1 --> В ДИСП70.КИК1
шзагс7	пам	2
масас7	конд	м47в'1'м44в'1'
	конд	м47в'1'
...
выдас7	сч	шкут  !ИЗ ТЕРМ.нтт4
	...
	мод	базсв7
	пб	прмhтр-СВЯЗЬ7 !В СВЯЗЬ7.прмhтр
