...
нтт3	уиа	(М10) М10 := 0
	слиа	1(М17)
	слиа	1(М12)
	уиа	'77660'(М5) В СТРОКЕ 80 СИМВОЛОВ
	пио	нтт4(М6) ВТ-340
	уиа	'77676'(М5) В СТРОКЕ 66 СИМВОЛОВ
	сч	ТСЛ(М2)
	и	E17
	пе	ОЧСИМВ КОНСУЛ
	уиа	(М12) ТЕЛЕТАЙП
...
МОТТ ВНЕШ шкмот2,(ПОСЛС,П143),УСТВД2,СNБЭСМ,NLС
...
ХЛАМ ВНЕШ ПОДВ80,несчет,н587,зпмг
