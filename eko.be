...
.ДА АНОП
	употр	ЭКО(М6)
	уиа	-2(М15)
эковхо	мода	п247 !НЕТ ПЕРЕД. УПР.
	сч	2(М15)
	слц	базэко !ИСП. ВЗУ
	мода	п247
	зп	2(М15)
...
*** ПРИЕМ ДАННЫХ ИЗ ДКС?
*
прцес1	сч	АЗУ(М4) !НЕТ ПЕРЕД. УПРАВЛ.
* ВЕРОЯТНО ДОЛЖНО БЫТЬ ИЗ СВЯЗЬ7
	сда	64+24
...
прцс1а	сч	базэко
	...
	и	К2013
	пе	с7эко1-СВЯЗЬ7(М4)
	сч	э52эк1-КОНФУС(М15) *
	сда	64-9
	нтж	э52эко-КОНФУС(М15) *
	и	E34
	пе	с7эко1-СВЯЗЬ7(М4)
	сч	э52эко-КОНФУС(М15)
	или	E34
	нтж	E34
	зп	э52эко-КОНФУС(М15)
	сч	(М15)
	уиа	'3'
	уиа	-20(М16)
G10037	мода	(М15)
...
*ПРОЦЕДУРА В КОНФУС НЕ ИСПОЛЬЗ.
	...
	мод	ГУС
	уиа	0(М17)
	сч	э52эк1-КОНФУС(М17)
	сда	64-9
	и	E34
	или	э52эко-КОНФУС(М17)
	зп	э52эко-КОНФУС(М17)
	мод	экояч
	уиа	0(М17)
	сч	рабдкс+1
	и	Е48П25
...
ДИСП70	ВНЕШ	К2013
МОТТ	ВНЕШ	шас01
КОНФУС	ВНЕШ	базсв7,рабдкс,базэко,завобм,экояч
КОНФУС	ВНЕШ	КОНФУС,экозап,э52эко,э52эк1
СВЯЗЬ7	ВНЕШ	СВЯЗЬ7,экояч1,вых133,с7эко1
СОСТАВ	ВНЕШ	МДР
