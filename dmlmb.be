...
A64277	сч	ЯЛИСМБ(М14)
 ...
 УИА 7(М1)
 СЧИ М14
	нтж	'72445'(М16) СВС: ШОЧНАП-1(М16)
	пе	ОПРБ6
	зп	'72445'(М16) ШОЧНАП-1(М16)
ОПРБ6 УИА ТВМБ1(М5)
 ПВ ОПРБ6А(М11)
 УИА 1027
 СЧ ШЗПОМБ
...
ДИСП70 ВНЕШ П3,П5,П77,П7,ПРИП,РАЗМГ,РЕЖРАЗ,РМЛ,РМР
...
ДИСП70 ВНЕШ ЯЛИСМБ,ЯМ15,ЯМ16,D00342,РЯО1,D01530,(Е6П1,П77)
ДИСП70 ВНЕШ D02006,(Е2Е1,П3),(Е3П1,П7),ЗОЧ1Б,ШКОМБ
ДИСП70 ВНЕШ (ПР14,П14),(ПР13,П13),П7777,МБЛИС,(Е12П1,П7777)
ДИСП70 ВНЕШ (КОДИК,ШИФРПЛ),(П77777,Е15П1),Е31П17,Е18П1,
 ВХОД A66010,A66007,A66013,ФТ1,A66004,ЗКМЛ,ДИСПМБ,ПРЛСЧА
 ВХОД A64770,ОБЩМГ
* ВРЕМЕННО
ТАБОШ ЭКВ '1140'
ПРИП1С ЭКВ '6347'
