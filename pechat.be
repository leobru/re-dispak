...
учтdw1	сда	64-15 <-учетdw. 30-16РР=-5 . М4
	...
	слц	E1 +1
учтбуф	зп	'1761'(М16) <-учбуф1 НА СМ Е1. ’1761’(М16):=СМ
	зп	D10035-П(М10) D10035-П(М10):= ’1761’(М16)
	и	E13 ?? СМЫСЛ  ’1761’(М16) В КАТ ВЫВ??
	пе	учбуф1 -> ЕСЛИ ’1761’(М16) >= 4096
	сч	'1761'(М16)
...
учвре1	сч	типтик <-учвре. М2=ЗНАЧ-Е ТЕКУЩ ТИПА Т
	...
	мода	учвре
	цикл	(М4) ->учвре, М4:=М4+1 (М4=-1 И =0)
	сч	типтик учвре=6 ЦИФР: 2-ЧАС,2-МИНУТА,2-СЕКУНДА
...
*ГОД В тучdw4
	...
	слц	тучdw4 + К ТРЁМ ЦИФРАМ ГОД В ЯЧ тучdw4
	слц	ЕДИНИЦ 6 СИМВОЛОВ УВЕЛИЧИЛИ НА 1
...
пердрв	мода	14(М16) <-учвре1,пердрв. ПРЕРЕПИСЬ ЯЧ. ДРАЙВЕРА АЦПУ
	сч	учетdw С учетdw ПО учтdw1
