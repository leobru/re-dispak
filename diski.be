...
ЗАНКМД	конд	в'4000000000000000'
	конд	в'4000000000000000' !ВОЗМОЖНО ПРАВКА НИТИ
мзахв	пам	2
...
ПРД	пам	1
сохк	пам	2 !ОС-100
сохр	конд	в'0070777700401740' !В БОЭК1
пав	пам	1
ЯМГРП	пам	1
О40 КОНД В’-1’М39В’1’
NКОБ КОНД В’0’
...
.ДА5 АНОП
*
*** ЗАПУСК ТЕСТА ПРЕРЫВАНИЙ УДАЛ. НМД "КОНВОЙ"
*
	сч	aпрмд7
	пб	дтпре !->МОТТ->КОНФУС.ТПРЕ
aпрмд7	конд	A(прмд7)
.НЕТ4 АНОП
прмд7	сч	ШКПРЕ  !ДИСКИ-100 СТР. 713
	или	E32(М16)
	нтж	E32(М16)
	зп	ШКПРЕ
	сч	ОЖОСВ-3(М16)
...
*
.ДА6 АНОП
	пе	опргд2 !МАЛ. НАМ ЗДЕСЬ НЕЛЬЗЯ НА 'ЗАН' (ЗАВИСНЕМ)
*
.НЕТ5 АНОП
	уиа	'2003'
	сч	ШЗПОМД
...
.ДА8 АНОП
*
*** ПРОЦЕДУРА ПРОВЕРКИ УДАЛ. НМД
*** ОБЩ. ТЕСТ. "КОНВОЙ".
*
тмдоб7	сч	аосвкм !РАБОТА К-71
	пб	дтобщ  !В МОТТ - ЗАТЕМ КОНФУС.ТОБЩ
...
ВЫБРЗК	сч	ВСЕЕД
	...
	или	Е48-1(М12)
	нтж	Е48-1(М12)
	зп	ШЗЗ РАЗРЕШИТЬ ПРИЕМ СЛЕД. ЗК
	пб	СНЗЩД
СНЯЛИЗ	сч	41(М10)
	и	Е47П1
	зп	41(М10)
...
обрнев	сч	типош-3(М16)
	и	е36е35
	по	обрвн1 В ЗОНЕ НЕТ ДЕФЕКТНЫХ ДОРОЖЕК
	сч	типком-3(М16)
	нтж	E3
	по	обрне1
	сч	П377
...
.ДА12А АНОП
*
*** ЗАПУСК ТЕСТА ПРОВЕРКИ УДАЛ. НМД
*** ПРИ ПОДКЛЮЧЕНИИ "КОНВОЙ"
*
	сч	адтпро
	пб	дтпро ->МОТТ->КОНФУС
адтпро	конд	A(*+1)
.НЕ12А АНОП
	сч	ОЖОСВ-3(М16)
	сда	64+39
