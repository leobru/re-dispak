...
ПНО	конд	м24п' -↑'
	пам	1
П7П7 КОНД М4В’7’В’7’
	конд	в'4000000000000000' 33
май77	конд	в'0000000060000000'
О18П15 КОНД М14В’17’В’-1’
	пам	1 44
вл	конд	в'6000000001000000'
...
* УИА 1027
 ...
 ПО ВЫХ1          НЕ БЫЛО ДИРЕК.’НЕТ ДИА’
	пам	0
 НТЖ ЗАНЯТА 0 -> 44Р. ЯЧЕЙКИ "ЗАНЯТА"
 ЗП ЗАНЯТА
...
*** ДКС  ***
	...
	и	E48(М2)
	пе	ЗАПР1
	сч	шкут шкала терм. через ДКС (S-ТЕРМ.)
	и	E48(М2)
	пе	ЗАПР4
******
	сч	ТСЛ(М2)
...
ВДОП1	сч	E17
 ...
 ПЕ ОТЛРАБ  ЗАНЯТ БУФ.ВЫВОДА
	сч	E17
	пв	ЗАХЗАН(М15) Захват буфера через "ЗАНЯТА"
 СЧ ШЗПРИМ
 ИЛИ Е48(М2)
...
ДИСП70 ВНЕШ (Q,Е18П16),ТРР1,ИЗ10В8,ШСБРОС,ШЗЗ
