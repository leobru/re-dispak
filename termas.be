...
ШККРТ	конд	в'7777777777777777' ШKAЛA KPEДИTA TEPMИHAЛA
...
* CЧ ГОД  
	...
	или	таск71(М17) !ТАС
	зп	таск71(М17)
	пв	втерм1(М15) !ПИЛОТ. УCTAHОBKA PAБОTЫ БHБОT'У
	слиа	1(М16)
...
СТЕР2	сч	9(М17)
	...
	сч	1(М16)
	по	СТЕР3
	зп	тблк71(М15) AДPEC ОЧEPEДHОГО PEKОPДA --> TБЛ
	пб	ФБВЫВТ
СТЕР3	сч	(М16)
	слц	П77777
	и	П77777
...
*ПО (M15) ЭTОT CИMBОЛ HE ПPИHИMATЬ  
	...
	зп	R(М13)
	пв	облк71(М15) !ОБЛ
	пб	втерм2 !VIDEOT. HA ПEPEДAЧУ CИMBОЛA MОTT'У
ВЫХКТ	мод	АДРВЫХ
	уиа	0(М15)
	мод	Р
	уиа	0(М13)
...
ДИСП70	ВНЕШ	П177,П3,П17,Р,П7777,ГОД,П77777,GRP24,таск71
ДМЛМБ	ВНЕШ	ДМЛМБ
КИТ	ВНЕШ	ЧСТР,тблк71
МОТТ	ВНЕШ	П215,шзнктп,КЛЮЧТМ,R,шкаск7,втерма,втерм1
МОТТ	ВНЕШ	втерм2
ХЛАМ	ВНЕШ	н1469
	ФИНИШ
